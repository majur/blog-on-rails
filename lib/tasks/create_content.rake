...
namespace :posts do
  ...
  task :create, %i[title content user_id published created_at] => :environment do |_, args|
...
namespace :pages do
  ...
  task :create, %i[title content user_id published is_blog_page is_in_menu] => :environment do |_, args|
    unless args[:title] && args[:user_id]
      puts 'ERROR: Title and user ID are required parameters.'
...
namespace :settings do
  ...
  task :create, %i[blog_name registration_enabled] => :environment do |_, args|
